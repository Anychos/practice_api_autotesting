...
- **Интеграция в CI/CD:** проект настроен на автоматический запуск тестов в CI/CD GitHub Actions при каждом коммите в main ветку.
- **Автоматизация отчетов:** после каждого прогона тестов генерируется отчет Allure.
- **Swagger coverage tool:** используется для измерения покрытия API тестами.
...
- Дописать негативные тесты на регистрацию
